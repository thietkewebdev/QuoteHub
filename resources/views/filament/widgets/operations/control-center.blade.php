        ...
        >
            ...
            <div class="flex flex-col gap-2 sm:flex-row sm:flex-wrap sm:justify-end">
                @foreach ($quickActions as $action)
                    ...
                    >
                        @if ($action['icon'] === 'plus')
                            <svg class="block h-4 w-4 shrink-0 text-primary-600 dark:text-primary-400" width="16" height="16" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" style="max-width: 16px; max-height: 16px">
